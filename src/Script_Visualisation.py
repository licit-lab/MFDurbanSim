...
#with open('/Volumes/Data/Dropbox/Projets/Symures-dev/git/symures-dev/examples/SingleRes/DemSC1/Network.json', "r") as file:
with open('/Volumes/Data/Dropbox/Projets/Symures-dev/samples/3reservoirs/Network.json', "r") as file:
